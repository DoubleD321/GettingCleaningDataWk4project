...
names(fullCombo)<- make.names(names(fullCombo))
names(fullCombo)<- gsub('Acc',"Acceleration",names(fullCombo))
names(fullCombo)<- gsub('GyroJerk',"AngularAcceleration",names(fullCombo))
names(fullCombo)<- gsub('Gyro',"AngularSpeed",names(fullCombo))
names(fullCombo)<- gsub('Mag',"Magnitude",names(fullCombo))
names(fullCombo)<- gsub('^t',"TimeDomain.",names(fullCombo))
names(fullCombo)<- gsub('^f',"FrequencyDomain.",names(fullCombo))
names(fullCombo)<- gsub('\\.mean',".Mean",names(fullCombo))
names(fullCombo)<- gsub('\\.std',".StandardDeviation",names(fullCombo))
names(fullCombo)<- gsub('Freq\\.',"Frequency.",names(fullCombo))
names(fullCombo)<- gsub('Freq$',"Frequency",names(fullCombo))
...
meanStd<- as.data.frame(grepl("activityId" , colNamesFC) | grepl("subjectId" , colNamesFC) | grepl(".Mean" , colNamesFC) | grepl(".StandDeviation" , colNamesFC))
...
tidyData <- meanStdActNames %>% group_by(subjectId,activity) %>% summarize_each(funs(mean))
